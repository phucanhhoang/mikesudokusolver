...
public class SudokuGui extends Frame
{
    ...
    private void initialize()
    {
        ...
        //
        this.setBackground(Constants.FRAME_BACKGROUND);
        this.setSize(Constants.BOARD_SIZE*Constants.CELL_SIZE + Constants.BUTTON_SIZE, Constants.BOARD_SIZE*Constants.CELL_SIZE);
        ...
        buttonPanel.setSize(Constants.BUTTON_SIZE, Constants.BOARD_SIZE*Constants.CELL_SIZE);
    ...
    public void boardSolved(SudokuPuzzle puzzle)
    {
        ...
        for (int i = 0; i < Constants.BOARD_SIZE; i++)
            ...
            {
                gameBoard.setValueAt(i, j, board[i][j], puzzle.isLegalMove(i, j, board[i][j]));
